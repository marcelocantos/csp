...
(* Steal-to-local (same as fixed protocol) — bug is only in the check. *)
TStealDelinkLocal ==
    /\ pc_thief = "t_delink_local"
    /\ steal_cand /= "none"
